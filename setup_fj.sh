...
echo "| 正在删除残留文件                            |"
echo "+---------------------------------------------+"
rm -rf   /root/fj_admin/fb/fb.tar.gz  /root/fj_admin/vt/vt.tar.gz
...
docker run -d --name qbittorrent -e PUID=1000 -e PGID=1000 -e TZ=Asia/Shanghai -e WEBUI_PORT=8989 -p 8989:8989 -p 45000:45000 -p 45000:45000/udp -v /root/fj_admin/qb/config:/config -v /home/downloads:/downloads -v /root:/root --restart unless-stopped lscr.io/linuxserver/qbittorrent:14.3.9
